...
silent only
cd /u/documents/VisualDSP\ Projects/SharcDSPHarmonizer/Block\ Based\ TalkThru\ (C)
...
badd +19 main.c
badd +86 ad1835.h
badd +50 IRQprocess.c
badd +1 initDAI.c
badd +17 initPLL.c
badd +14 initSPORT.c
badd +38 SPORTisr.c
badd +0 blockProcess.c
badd +0 init1835viaSPI.c
badd +0 tt.h
badd +10 stuff.vim
argglobal
silent! argdel *
...
silent! normal! zE
let s:l = 77 - ((1 * winheight(0) + 13) / 26)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 52 - ((0 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 29 - ((22 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 100 - ((22 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((0 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
